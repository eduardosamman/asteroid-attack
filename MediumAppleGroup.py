# -*- coding: utf-8 -*-
"""
Created on Wed Mar 22 11:11:27 2023
...
from mediumapple import MediumApple

class MediumAppleGroup(pg.sprite.Group):
    ...
    def add_new_golden(self):
        ...
        speed=randint(1,6)
        a=MediumApple(self.path,pos,speed,self.box)
